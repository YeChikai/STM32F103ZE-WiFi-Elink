...
//				ELINK042_DispString_EN_CH( 64, 80, pCh, WHITE); //display CMD infomation on the Elink ePaper
			...
			{
				cCh = * ( pCh + 11 );
//				ELINK042_DispString_EN_CH( 64, 96, pCh, WHITE); //display CMD infomation on the Elink ePaper				
